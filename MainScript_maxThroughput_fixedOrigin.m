...
[mdata,stoppage_time] = get_data_amount(N,1,survival_time,cluster_set,dgr);

for i=1:N
    if( cluster_set(1,i) == 1)
...
fid = fopen('C:\Users\lenovo\Desktop\MyOutput\Outputs at_T=800\Max_fixedOrigin_n=600_t=800.txt','a+');
fprintf(fid,'%d', ratio);
fprintf(fid,'\r\n');
fclose(fid);
