function [index,mdata,cluster_data,sojourn_time,stoppage_time,energy] = get_first_index(feasible_loc,survival_time,sojourn_time,cluster_set,energy,cluster_data, dgr, M, N)
